...
describe('DIGIT 5', () => {
    ...
    it('90999', () => {assert.equal(convert(90999), 'девяносто тысяч девятсот девяносто девять')});
    it('90019', () => {assert.equal(convert(90019), 'девяносто тысяч девятнадцать')});
    it('91999', () => {assert.equal(convert(91999), 'девяносто одна тысяча девятсот девяносто девять')});
});

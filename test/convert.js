...
describe('DIGIT 18', () => {
    it('1000000000000000000', () => {assert.equal(convert(1000000000000000000), 'один квинтиллион')});
    it('2000000000000000000', () => {assert.equal(convert(2000000000000000000), 'два квинтиллиона')});
});

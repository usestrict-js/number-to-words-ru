...
describe('NEGATIVE DIGIT', () => {
    it('-1', () => { assert.equal(convert(-1), 'минус один') });
    it('-2', () => { assert.equal(convert(-2), 'минус два') });
    it('-3', () => { assert.equal(convert(-3), 'минус три') });
    it('-4', () => { assert.equal(convert(-4), 'минус четыре') });
    it('-5', () => { assert.equal(convert(-5), 'минус пять') });
    it('-6', () => { assert.equal(convert(-6), 'минус шесть') });
    it('-7', () => { assert.equal(convert(-7), 'минус семь') });
    it('-8', () => { assert.equal(convert(-8), 'минус восемь') });
    it('-9', () => { assert.equal(convert(-9), 'минус девять') });
});
...
describe('DIGIT 2', () => {
    ...
    it('-87', () => { assert.equal(convert(-87), 'минус восемьдесят семь') });
});
...
describe('DIGIT 3', () => {
    ...
    it('-998', () => { assert.equal(convert(-998), 'минус девятьсот девяносто восемь') });
});
...
describe('DIGIT 4', () => {
    ...
    it('-9898', () => { assert.equal(convert(-9898), 'минус девять тысяч восемьсот девяносто восемь') });
});

describe('DIGIT 5', () => {
    it('10000', () => { assert.equal(convert(10000), 'десять тысяч') });
    it('10001', () => { assert.equal(convert(10001), 'десять тысяч один') });
    it('15998', () => { assert.equal(convert(15998), 'пятнадцать тысяч девятьсот девяносто восемь') });
    ...
    it('88888', () => { assert.equal(convert(88888), 'восемьдесят восемь тысяч восемьсот восемьдесят восемь') });
    ...
    it('-91999', () => { assert.equal(convert(-91999), 'минус девяносто одна тысяча девятьсот девяносто девять') });
});
...
describe('DIGIT 6', () => {
    ...
    it('921000', () => { assert.equal(convert(921000), 'девятьсот двадцать одна тысяча') });
    it('989898', () => { assert.equal(convert(989898), 'девятьсот восемьдесят девять тысяч восемьсот девяносто восемь') });
    it('-989898', () => { assert.equal(convert(-989898), 'минус девятьсот восемьдесят девять тысяч восемьсот девяносто восемь') });
});
...
describe('DIGIT 9', () => {
    ...
    it('-100000001', () => { assert.equal(convert(-100000001), 'минус сто миллионов один') });
});
...
describe('DIGIT 15', () => {
  it('1000000000000000', () => {assert.equal(convert(1000000000000000), 'один квадриллион')});
  it('2000000000000000', () => {assert.equal(convert(2000000000000000), 'два квадриллиона')});
  // it('99999999999999999999', () => {assert.fail(convert(9999999999999999), 'Нельзя передавать число больше Number.MAX_SAFE_INTEGER. Передайте число строкой, чтобы избежать ошибок округления.')});
});
